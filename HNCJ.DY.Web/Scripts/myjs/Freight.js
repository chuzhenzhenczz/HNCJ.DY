...
function initTable(data) {
    $('#tt').datagrid({
        ...
        columns: [[
            ...
            { field: 'FreightName', title: '快递名称', width: 120 },
            { field: 'FreightPrice', title: '运送费用（元）', width: 120 },
...
function editEvent(id) {
    ...
    $("#editframe").attr("src", "/Freight/Edit/" + id);
...
function deleteEvent(ids) {
    ...
    //alert(ids);
    $.post("/Freight/Delete", { ids: ids }, function (data) {
        if (data == "ok") {
            initTable();
        } else {
