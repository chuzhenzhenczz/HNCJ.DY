...
function initTable(data) {
    $('#tt').datagrid({
        ...
        columns: [[
            ...
            { field: 'PaymentName', title: '支付名称', width: 120 },
            { field: 'PaymentPrice', title: '支付费用', width: 120 },
...
function editEvent(id) {
    ...
    $("#editframe").attr("src", "/Payment/Edit/" + id);
...
function deleteEvent(ids) {
    ...
    //alert(ids);
    $.post("/Payment/Delete", { ids: ids }, function (data) {
        if (data == "ok") {
            initTable();
        } else {
