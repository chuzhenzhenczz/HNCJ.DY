...
function initTable(data) {
    $('#tt').datagrid({
        ...
        columns: [[
            ...
            { field: 'PaymentName', title: '支付方式', width: 120 },
            { field: 'FreightName', title: '配送方式', width: 120 },
            { field: 'Address', title: '地址', width: 120 },
            { field: 'Telphone', title: '电话', width: 120 },
            { field: 'UserName', title: '卖家', width: 120 },
            { field: 'HisName', title: '买家', width: 120 },
...
function editEvent(id) {
    ...
    $("#editframe").attr("src", "/OrderInfo/Edit/" + id);
...
function deleteEvent(ids) {
    ...
    //alert(ids);
    $.post("/OrderInfo/Delete", { ids: ids }, function (data) {
        if (data == "ok") {
            initTable();
        } else {
...
function addClickEvent() {
    $("#addframe").attr("src", "/OrderInfo/Add");
